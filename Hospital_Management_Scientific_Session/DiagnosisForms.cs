...
{
    public partial class DiagnosisForms : Form
    {
        public DiagnosisForms()
        {
            InitializeComponent();
        }
        ...
        private void DiagnosisForms_Load(object sender, EventArgs e)
        {
            populatecombo();
            populate();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                SqlCommand cmd = new SqlCommand(query, Con);
                cmd.ExecuteNonQuery();
                MessageBox.Show("Diagnosis Succesfully Deleted");
                Con.Close();
                populate();
            }
        }
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString("\n" + PatientNamelbl.Text + "\n" + Diagnosislbl.Text + "\n" + Symptomslbl.Text + "\n" + medicineslbl.Text + "\n", new Font("Century Gothic", 12, FontStyle.Bold), Brushes.Black, new Point(130));
